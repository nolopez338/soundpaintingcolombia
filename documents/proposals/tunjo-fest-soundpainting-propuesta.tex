...
\begin{titlepage}
  ...
  \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[height=1.8cm]{../../assets/images/logo_soundpaintingcolombia.jpeg}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[height=1.8cm]{../../assets/images/logo_fundacionLideresHumanitarias.jpeg}
  \end{minipage}
  \vspace{0.75cm}
